...
class ResolvedRuleModel(ForwardModel):
    def __init__(self, barrier=None, material=None, parameters=None):
        ...
        if q.mechanism_mode not in {"resolved_rules","defined_laws_port","defined_closed_laws_port"}: raise ValueError("unsupported mechanism_mode")
        mapping={"baseline_forward_current":"resolved_proxy_current","defined_laws_port":"resolved_proxy_current","resolved_proxy_current":"resolved_proxy_current","reduced_candidate_law_transfer":"resolved_proxy_current","candidate_reduced_transfer":"resolved_proxy_current","mechanistic_GB_diffusion":"GB_diffusion_closed_shrinkage","mechanistic_GB_diffusion_closed":"GB_diffusion_closed_shrinkage","mechanistic_renewal_limited":"renewal_limited_closed_shrinkage","mechanistic_renewal_closed":"renewal_limited_closed_shrinkage","mechanistic_gas_accommodation":"gas_accommodation_limited","mechanistic_surface_accommodation":"surface_diffusion_accommodation_only","empirical_rate_scale_diagnostic":"empirical_closed_rate_scale","empirical_closed_rate_diagnostic":"empirical_closed_rate_scale"}
        ...
        if (q.mechanism_mode in {"defined_laws_port","defined_closed_laws_port"} or q.closed_mapping_mode!="baseline_forward_current") and q.closed_channel_law != expected:q=replace(q,closed_channel_law=expected)
        if q.closed_mapping_mode=="mechanistic_gas_accommodation" and not q.closed_gas_enabled:q=replace(q,closed_gas_enabled=True)
        if q.closed_mapping_mode in {"reduced_candidate_law_transfer","candidate_reduced_transfer","mechanistic_GB_diffusion","mechanistic_GB_diffusion_closed","mechanistic_renewal_limited","mechanistic_renewal_closed","mechanistic_gas_accommodation","mechanistic_surface_accommodation","empirical_rate_scale_diagnostic","empirical_closed_rate_diagnostic"} and not q.binwise_closed_state:q=replace(q,binwise_closed_state=True)
    ...
    def rates(self,state:ModelState,T_K:float):
        ...
        diag["precursor_closed_i_json"]=json.dumps(p.phi_iso.tolist())
